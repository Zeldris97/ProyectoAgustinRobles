...
namespace Proyecto_final.Repository
{
    ...
    public class Usuario { 
        ...
        public static List<Proyecto_final.Models.Usuario> DevolverUsuario()
        {

            AccesoDatos ds = new AccesoDatos();
            List<Proyecto_final.Models.Usuario> _Usuario = new List<Proyecto_final.Models.Usuario>();
        ...
        public static Proyecto_final.Models.Usuario TraerUsuarioPorNombre(string NombreUsuario)
        {
            AccesoDatos ds = new AccesoDatos();
        ...
        public static Proyecto_final.Models.Usuario TraerUsuarioPorID(int IDUsuario)
        {
            AccesoDatos ds = new AccesoDatos();
        ...
        public static long CrearUsuario(Proyecto_final.Models.Usuario us)
        {
            AccesoDatos ds = new AccesoDatos();
        ...
        public static Proyecto_final.Models.Usuario IniciarSesion(string NombreUser, string Contraseña)
        {
            AccesoDatos ds = new AccesoDatos();
